...
function loadHeader() {
    ...
    if (header) {
        header.innerHTML = `
        <style>
            /* Dropdown ke liye naya CSS yahin add kar diya hai taaki style.css na chhedni pade */
...
// Ye function ab puraana ₹0 wala data automatic delete karega
function addToCart(serviceName, price, qtyId) {
    ...
    // SAFTEY CHECK: Purane bina price wale items filter karke hata do
