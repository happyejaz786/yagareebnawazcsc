    ...
    if (header) {
        ...
        <nav class="main-header-nav">
            ...
            <div class="logo-wrapper" onclick="location.href='index.html'">
                <img src="images/logo.jpg" alt="Logo" class="logo-spin" onerror="this.src='https://via.placeholder.com/80?text=Logo'">
                <div class="logo-text">
